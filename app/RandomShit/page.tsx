...
// import { AlertCircle, Terminal, Zap, Power, Disc, Bot } from "lucide-react";
...
//       // Add a temporary message with a unique ID
...
//         // Remove the temporary message and add the AI response
...
//         case "help":
//           newHistory.push(
//             "Available commands: help, clear, hack, matrix, ask [your question], exit"
//           );
//           break;
//         case "clear":
//           setHistory([]);
...
//           setTimeout(() => document.body.classList.remove("matrix-bg"), 10000);
//           break;
//         case "exit":
//           newHistory.push("System shutdown initiated...");
//           setTimeout(() => {
//             setHistory(["System rebooted. Welcome back, hacker."]);
...
//       setTimeout(() => {
//         setIsBooting(false);
//         setHistory(["Booting TerminalOS v3.0...", 'Type "help" for commands']);
//       }, 3000);
//     }
//   };
...
//       <h2 className="text-center text-green-500 mb-4">
//         Play with The Terminal
//       </h2>
//       <div className="flex-grow flex items-center justify-center">
//         <div className="w-full max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl bg-gray-800 rounded-lg shadow-2xl flex flex-col overflow-hidden">
//           {/* PC Case Top */}
...
//                   <div
//                     ref={outputRef}
//                     className="h-full overflow-auto pb-8 terminal-output text-green-500 font-mono"
//                   >
...
//             ) : (
//               <div className="h-full flex items-center justify-center">
//                 <span className="text-gray-600 text-2xl">Monitor is off</span>
//               </div>
//             )}
//           </div>
...
//               <span className="text-gray-300 text-sm">Disc</span>
//             </div>
//             <div className="flex items-center space-x-2">
...
const Component: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black p-4">
      <h2 className="text-center text-green-500 mb-4 text-2xl font-mono">
        HackerOS v3.1337
      </h2>
      <div className="flex-grow flex items-center justify-center">
              ...
              <>
                ...
                {isBooting ? (
                  <div className="h-full flex items-center justify-center">
                    <div className="text-center">
                      <Terminal className="w-16 h-16 mb-4 mx-auto animate-pulse text-green-500" />
                      <h1 className="text-2xl mb-4 text-green-500 font-mono">
                        HackerOS v3.1337
                      </h1>
                      <div className="w-64 h-2 bg-green-900 rounded-full">
                        <div className="w-0 h-full bg-green-500 rounded-full animate-load"></div>
